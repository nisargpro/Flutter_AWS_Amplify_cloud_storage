...
import 'package:drive_clone/auth/login.dart';
  ...
  logout() async {
    try {
      ...
      Alert(
          ...
          desc: "Error Logging Out: " + e.toString(), title: 'logging error').show();
    }
  }
  ...
  void deleteFile(StorageItem item) async {
    try {
      ...
      Alert(
          context: context,
          type: AlertType.error,
          desc: "Error Deleting File: " + e.toString(), title: 'error deleting file')
          .show();
    }
  }
  ...
  void uploadFile() async {
    ...
    try {
      ...
      Alert(
          context: context,
          type: AlertType.error,
          desc: "Error Uploading File: " + e.toString(), title: 'error uploading files');
    }
  }
  ...
  Future<List<StorageItem>> listFiles() async {
    try {
      ...
      Alert(
          context: context,
          type: AlertType.error,
          desc: "Error Listing Files: " + e.toString(), title: 'error listing files');
